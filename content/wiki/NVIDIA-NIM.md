...
- **Retriever integration:** [[NeMo-Retriever]] uses NIM microservices for embedding, reranking, OCR, object/document extraction, and multimodal embeddings; see [[NeMo-Retriever-Embedding-NIM]], [[Llama-Nemotron-Embed-VL-1B-v2]], [[NeMo-Retriever-Reranking-NIM]], [[NIM-for-Image-OCR]], [[NIM-for-Object-Detection]], and [[NIM-for-NV-CLIP]].
- **Multimodal retrieval and reranking:** [[Llama-Nemotron-Embed-VL-1B-v2]] is a Build NVIDIA embedding model for visual document retrieval, and [[Llama-Nemotron-Rerank-VL-1B-v2]] reranks visual document candidates.
