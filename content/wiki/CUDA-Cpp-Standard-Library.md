...
**Related:** [[NVIDIA-CUDA]], [[Thrust]], [[CUB]], [[cuda-parallel]], [[NVCC]], [[CUDA-Runtime-API]]
**Sources:** https://nvidia.github.io/cccl/libcudacxx/
**Last Updated:** 2026-04-29

## Summary
The CUDA C++ Standard Library, often referred to as libcu++, provides CUDA-capable C++ standard library facilities for host and device code. It is part of NVIDIA's broader CUDA C++ Core Libraries (CCCL) stack alongside [[Thrust]], [[CUB]], and related Python-facing parallel algorithm work.
...
- Alignment with CCCL components used by [[Thrust]], [[CUB]], and Python parallel APIs.
...
- [[cuda-parallel]] - Python-facing bindings are built around CCCL algorithmic components.
