...
- **Retrieval:** Llama Nemotron reranking and embedding models, including [[Llama-Nemotron-Embed-VL-1B-v2]] and [[Llama-Nemotron-Rerank-VL-1B-v2]], connect Nemotron to [[NeMo-Retriever]], [[NeMo-Retriever-Embedding-NIM]], and enterprise RAG workflows.
...
- [[NeMo-Retriever]], [[NeMo-Retriever-Embedding-NIM]], [[Llama-Nemotron-Embed-VL-1B-v2]], and [[Llama-Nemotron-Rerank-VL-1B-v2]] - retrieval layer and model-specific embedding/reranking pages related to Nemotron.
