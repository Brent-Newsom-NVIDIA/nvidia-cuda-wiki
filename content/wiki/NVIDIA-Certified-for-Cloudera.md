...
The docs cover platform components, reference-build hardware configurations, network and storage topology, and a sample use case around customer churn. Because the source is older than many current NVIDIA docs, this page should be treated as NVIDIA-authored certified/reference material rather than a fast-moving product page.
...
- [[NVIDIA-Cloud-Native-Technologies]] - Kubernetes/container deployment concepts overlap with modern data-platform operations.

## Source Excerpts
- NVIDIA's Cloudera docs list NVIDIA-Certified Systems, Cloudera Data Platform, CDP Private Cloud Base, Apache Spark, RAPIDS Accelerator for Apache Spark, and reference architecture sections.
