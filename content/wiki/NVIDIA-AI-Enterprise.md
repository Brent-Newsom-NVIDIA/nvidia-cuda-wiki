...
- **NIM Microservices:** Full access to the NIM catalog — LLMs, embedding models, rerankers, vision-language, speech, safety/guardrails, physical AI, weather/climate, visual generation, audio enhancement, and biology models — under enterprise license for on-premises, data-private deployment. Current pages include [[NIM-for-Large-Language-Models]], [[NeMo-Retriever-Embedding-NIM]], [[NeMo-Retriever-Reranking-NIM]], [[NIM-for-Vision-Language-Models]], [[NIM-for-Visual-Generative-AI]], [[NVIDIA-Speech-NIM-Microservices]], and [[NVIDIA-NemoGuard-NIMs]].
