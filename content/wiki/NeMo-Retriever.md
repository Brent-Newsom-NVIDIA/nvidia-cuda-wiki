...
**Related:** [[NVIDIA-NeMo]], [[NeMo-Platform]], [[NVIDIA-NIM]], [[cuVS]], [[NVIDIA-Agent-Intelligence-Toolkit]], [[Nemotron]]
**Sources:** https://docs.nvidia.com/nemo/retriever/latest/index.html
...
### NVIDIA context
NeMo Retriever is a central bridge between enterprise data and NVIDIA agent systems. It connects [[NVIDIA-NIM]] model endpoints, [[NVIDIA-Agent-Intelligence-Toolkit]] workflows, [[Nemotron]] reasoning models, and vector-search acceleration.
