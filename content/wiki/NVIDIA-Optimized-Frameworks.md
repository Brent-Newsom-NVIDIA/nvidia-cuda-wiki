...
## Summary
NVIDIA Optimized Frameworks is NVIDIA's documentation and container distribution surface for GPU-optimized deep learning framework images. It covers preparing systems to use framework containers, pulling and running containers from [[NGC]], customizing/extending images, and reading the support matrix that maps each container release to its bundled CUDA, framework, communication, profiling, notebook, and acceleration components.
...
- Deep learning frameworks such as [[PyTorch]], [[TensorFlow-GPU]], and [[JAX]].
